...
echo "python -m huitre train --verbose -p configs/amzb/10-core/jupiter-e/fo_margin0.5.json"
python -m huitre train \
  --verbose \
  -p configs/amzb/10-core/jupiter-e/fo_margin0.5.json \
  >& exp/logs/amzb_fo-10core/jupiter-e/fo_lr0.00075_margin0.5_pref10_unpop.log

echo "python -m huitre eval --verbose -p configs/amzb/10-core/jupiter-e/fo_margin0.5.json"
# CUDA_VISIBLE_DEVICES="" python -m huitre eval --verbose -p configs/amzb/10-core/jupiter-e/fo_margin0.5.json
python -m huitre eval --verbose -p configs/amzb/10-core/jupiter-e/fo_margin0.5.json
